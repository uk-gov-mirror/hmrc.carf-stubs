...
object NotificationType {
  implicit val reads: Reads[NotificationType] = Reads[NotificationType] {
    ...
    case value                             => JsError(s"Unexpected value of NotificationType: $value")
  }

  implicit val writes: Writes[NotificationType] = Writes[NotificationType] {
